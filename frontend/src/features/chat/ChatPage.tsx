 ...
 * Boş sohbet AnimatedAIChat hero'su ile açılır (komut paleti + hızlı eylemler);
 * ilk mesajla klasik thread + composer'a geçilir. Hero kendi arka planını
 * çizmez — Layout'taki NightSkyBackground animasyonu aynen arkada kalır.
  ...
  return (
    <div className="mx-auto flex h-[calc(100vh-9rem)] max-w-5xl gap-4 supports-[height:100dvh]:h-[calc(100dvh-9rem)]">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-4">
        {isEmpty ? (
          <AnimatedAIChat onSend={sendMessage.send} disabled={sendMessage.isPending} />
        ) : (
          <>
            <MessageList
